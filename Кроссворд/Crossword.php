...
<h1>Кроссворд</h1>
<h3 style="margin-top: -1em;">Александр</h3>
...
<script type="text/javascript"><!--
	...
	CrosswordHeight = 14;
	Words = 7;
	WordLength = new Array(10, 6, 6, 7, 9, 5, 4);
	Word = new Array("КОМПИЛЯТОР", "РЕСУРС", "МАССИВ", "ФУНКЦИЯ", "ПРОГРАММА", "ВИРУС", "ШИНА");
	Clue = new Array("Средство для сборки программы", 
"То, что используется для достижения результата", 
"Набор значений, к которым можно обращаться по их индексу.", 
"Обособленный фрагмент программного кода", 
"Набор команд, которые необходимо выполнить для достижения результата", 
"Вредоносная программа", 
"Необходима для для передачи данных между блоками компьютера");
	AnswerHash = new Array(69189, 61576, 43063, 86009, 61729, 82495, 1145);
	WordX = new Array(0, 1, 1, 6, 1, 4, 5);
	WordY = new Array(6, 8, 11, 0, 4, 5, 10);
